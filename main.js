...
cakeBuddiesImg.addEventListener('click', function () {
    if (cakeBuddiesState == "off") {
        ...
        switchSound.play();
        setTimeout(function () { cakeBuddiesImg.src = "cake-buddies-lit.png"; }, 9000);
        setTimeout(function () { nextPageButton.style.display = "inline"; }, 64500);
        setTimeout(function () {
        ...
        let birthdaySong = new Audio('happy-birthday-aman.mp3');
        birthdaySong.play();
    }
})
